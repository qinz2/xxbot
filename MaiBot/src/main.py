...
""")
    ...
    async def _init_components(self):
        ...
        # ❌ 删除旧的 Godot 处理器注册（这两行必须删除）
        # from src.godot_handler import godot_message_processor
        # self.app.register_custom_message_handler("godot_message", godot_message_processor)
